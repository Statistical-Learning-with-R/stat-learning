...
You might need to use Wikipedia to figure out the style / genre of artists you are not familiar with. You can also put your cluster centers information into Chat GPT and ask it to interpret them for you! (You're still responsible for double-checking this output.)
:::
