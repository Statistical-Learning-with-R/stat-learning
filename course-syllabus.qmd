...
The conceptual portion of the final exam will take place on the last day of class (December 6) and the take-home exam will be due at scheduled time of our final exam (December 15, 4:00pm). Note that due to time constraints, there will not be an opportunity to complete revisions on the final exam. 
...
-   Obtain a "satisfactory"^[This means that **every** section was marked a "success"] on all but 2 labs assignments
-   Obtain a "satisfactory" conditions of the rubric on **both** the conceptual and application portions of the midterm exam[^4].
-   Submit the final project on time and meet the "satisfactory" conditions on the rubric.
-   Obtain a "satisfactory" conditions of the rubric on **both** the conceptual and application portions of the midterm exam.

[^2]: See @sec-late for information on deadline extensions

[^3]: See @sec-late for information on deadline extensions

[^4]: This can be obtained in either the first attempt or after **one** round of revisions

**Grade Deductions** Your grade will decrease by a third of a step (for example a B to a B-) for each B condition that you do not meet. Missing assignments will be scaled, so that if for example you miss six activities, turn in two homework assignments late, or turn in your final project late your grade will decrease by two thirds of a step (for example a B to a C+).

Missing an exam or a project will result in a maximum grade of a C at the instructor's discretion.
...
- Obtain a "Excellent" on **both** portions of the midterm exam.
- Obtain a "Excellent" on **both** portions of the final exam.
