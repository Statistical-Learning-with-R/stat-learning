...
You will submit an HTML document to Gradescope as your final version.
...
Download the [`heart_attack_validation.csv`](data/heart_attack_validation.csv) and read in the data. Remember to clean these data the **same** way you cleaned the training data.
