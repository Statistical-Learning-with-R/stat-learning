...
A [support vector machine]{style="color: #ed8402;"} is an extension of the support vector machine classifer that results from enlarging the feature space in a specifc way, using [kernels]{style="color: #ed8402;"}. 
