...
3.  How does the RMSE compare to the model with `smoker`? How does the R-squared compare?
...
5.  How do the RMSE and R-squared compare to the model when we just used `age` (Part 2, Question 1)?
...
6.  Let's get a little wigglier! Fit a polynomial model of degree 4. How do the RMSE and R-squared compare to the model when we just used `age` (Part 2, Question 1)?
