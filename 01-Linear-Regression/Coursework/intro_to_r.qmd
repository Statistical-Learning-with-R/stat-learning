...
> R version 4.4.1 (2024-06-14) -- "Race for Your Life" Copyright (C) 2024 The R Foundation for Statistical Computing

If the version **is not** 4.4.1, you need to update your version of R!
...
If you already have RStudio, you need to double check if you have the most recent version (2024.04.2+764). You **cannot** create Quarto documents (what we will live and breathe) unless you have a recent version of RStudio.
...
::: callout-caution
Hint: If your version is not 4.4.1 you will be given an incomplete and asked to install the most recent version of R
:::
...
::: callout-caution
Hint: If your version is not 2024.04.2+764 you will be given an incomplete and asked to install the most recent version of RStudio
:::
